...
/**
 * Created by Jesus Marcano on 26/10/2017.
 */
...
public class GrafoDirigido {
    ...
    private int numV; // numero total de vertices que lee el grafo
    private int numL; // numero totl de aristas del grafo
    ...
    public boolean cargarGrafo(String dirArchivo) {
        try {
            ...
            int numLados = Integer.parseInt(in.next());
            ...
            for (int i=0; i<numVertices; i++) {
                ...
                linea[0] = in.next();
                linea[1] = in.next();
                this.agregarVertice(linea[0], Double.parseDouble(linea[1]));
            }
            for (int j=0; j<numLados; j++) {
                String[] lineaL = new String[4];
                boolean agrego;
                lineaL[0] = in.next();
                lineaL[1] = in.next();
                lineaL[2] = in.next();
                lineaL[3] = in.next();
                agrego = this.agregarArco(lineaL[0], Double.parseDouble(lineaL[3]), lineaL[1], lineaL[2]);
            }
            grafoCargado = true;
            return grafoCargado;
        }
