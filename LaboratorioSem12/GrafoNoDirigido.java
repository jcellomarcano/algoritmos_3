...
*/
    ...
    public boolean cargarGrafo(String dirArchivo) throws IOException{
        ...
        for (int i=0; i<nVertices; i++){
            ...
            posX = Double.parseDouble(in.next());
            posY = Double.parseDouble(in.next());
        ...
        nLados = Integer.parseInt(in.next());
