        ...
        try {
            ...
            */
            ...
            for (int j=0; j<numLados; j++) {
                String[] lineaL = new String[2];
                boolean agrego;
                lineaL[0] = in.next();
                lineaL[1] = in.next();
                this.agregarVertice(lineaL[0],Double.parseDouble(lineaL[0]));
                this.agregarVertice(lineaL[1],Double.parseDouble(lineaL[1]));
                agrego = this.agregarArco(lineaL[0], Double.parseDouble(lineaL[0]), lineaL[0], lineaL[1]);
            }
            grafoCargado = true;
            return grafoCargado;
        }
